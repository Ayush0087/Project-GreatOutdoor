...

{
    ...
    public class UpdateSalesPersonBLTest
    {
       ...
       [TestMethod]
        ...
        public async Task SalesPersonNameCanNotBeNull()
        {
            ...
            try
            {
                isUpdated = await salesPersonBL.UpdateSalesPersonPersonBL(salesPerson2);
            }
            catch (Exception ex)
            {
                isUpdated = false;
        ...
        public async Task SalesPersonMobileCanNotBeNull()
        {
            //Arrange
            SalesPersonBL salesPersonBL = new SalesPersonBL();
            SalesPerson salesPerson1 = new SalesPerson() { SalesPersonName = "Smith", SalesPersonMobile = "9098850371", Password = "Smith123#", Email = "smith@gmail.com" };
            await salesPersonBL.AddSalesPersonBL(salesPerson1);
        ...
        public async Task SalesPersonNameShouldContainAtLeastTwoCharacters()
        {
            //Arrange
            SalesPersonBL salesPersonBL = new SalesPersonBL();
            SalesPerson salesPerson1 = new SalesPerson() { SalesPersonName = "John", SalesPersonMobile = "9877897890", Password = "John123#", Email = "john@gmail.com" };
            await salesPersonBL.AddSalesPersonBL(salesPerson1);
            ...
            {
                //Assert
                Assert.IsFalse(isUdated, errorMessage);
            }
        }
        ...
        public async Task SalesPersonMobileRegExp()
        {
            ...
            await salesPersonBL.AddSalesPersonBL(salesPerson1);
            SalesPerson salesPerson2 = new SalesPerson() { SalesPersonName = "John", SalesPersonMobile = "9877", Password = "John123#", Email = "john@gmail.com" };
        ...
        public async Task SalesPersonPasswordRegExp()
        {
            ...
            SalesPerson salesPerson1 = new SalesPerson() { SalesPersonName = "John", SalesPersonMobile = "9877897890", Password = "John123#", Email = "john@gmail.com" };
            await salesPersonBL.AddSalesPersonBL(salesPerson1);
            SalesPerson salesPerson2 = new SalesPerson() { SalesPersonName = "John", SalesPersonMobile = "9877897890", Password = "a", Email = "john@gmail.com" };
        ...
        public async Task SalesPersonEmailRegExp()
        {
            ...
            SalesPerson salesPerson1 = new SalesPerson() { SalesPersonName = "John", SalesPersonMobile = "9877897890", Password = "John123#", Email = "john@gmail.com" };
            await salesPersonBL.AddSalesPersonBL(salesPerson1);
            SalesPerson salesPerson2 = new SalesPerson() { SalesPersonName = "John", SalesPersonMobile = "9877897890", Password = "John123#", Email = "john" };
    ...
    public class GetSalesPersonBLTest
    {
        ...
        public async Task GetAllValidSalesPersons()
        {
            //Arrange
            SalesPersonBL salesPersonBL = new SalesPersonBL();
            SalesPerson salesPerson = new SalesPerson() { SalesPersonName = "John", SalesPersonMobile = "9877897890", Password = "John123#", Email = "john@gmail.com" };
        ...
        public async Task GetSalesPersonsByNameBL()
        {
            ...
            try
            {
                SalesPerson salesPerson1 = await salesPersonBL.GetSalesPersonsByNameBL(salesPerson.SalesPersonName);
                if (salesPerson.SalesPersonName == salesPerson1.SalesPersonName)
                {
                    isDisplayed = true;
                }
            }
        ...
        public async Task SalesPersonsNameDoesNotExist()
        {
            ...
            try
            {
               SalesPerson salesPerson1 = await salesPersonBL.GetSalesPersonsByNameBL("SalesPersonName");
            }
            catch (Exception ex)
            {
                isDisplayed = false;
        ...
        public async Task GetSalesPersonByEmailAndPasswordBL()
        {
            ...
            try
            {
              SalesPerson  salesPerson1 = await salesPersonBL.GetSalesPersonByEmailAndPasswordBL(salesPerson.Email, salesPerson.Password);
                if ((salesPerson.SalesPersonName == salesPerson1.SalesPersonName) && (salesPerson.SalesPersonPassword == salesPerson1.SalesPersonPassword))
                {
                    isDisplayed = true;
                }
            }
