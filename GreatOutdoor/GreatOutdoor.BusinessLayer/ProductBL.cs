...
namespace Capgemini.GreatOutdoor.BusinessLayer
{
    ...
    public class ProductBL : BLBase<Product>, IProductBL, IDisposable
    {
        ...
        public async Task<List<Product>> GetProductsByProductCategoryBL(string productCategory)
        {
            ...
            try
            {
                await Task.Run(() =>
                {
                    tempProductsList = productDAL.GetProductsByProductCategoryDAL(productCategory);
